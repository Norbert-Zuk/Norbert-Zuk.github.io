...
window.scrollReveal = function (t) {
    ...
    var i = 1,
        o = function () {
            return t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || function (e) { t.setTimeout(e, 1e3 / 60); };
        }();
    ...
    e.prototype = {
        ...
        genCSS: function (t) {
            ...
            // Sprawdzanie, czy ekran to urz¹dzenie mobilne
            if (window.innerWidth <= 768) {
                l = 1; // Ustawienie opacity na 1 na urz¹dzeniach mobilnych
            }

            var u = "-webkit-transition: -webkit-transform " + n + " " + a + " " + s + ",  opacity " + n + " " + a + " " + s + ";transition: transform " + n + " " + a + " " + s + ", opacity " + n + " " + a + " " + s + ";-webkit-perspective: 1000;-webkit-backface-visibility: hidden;",
